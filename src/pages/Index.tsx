...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Top Bar */}
      <div className="bg-card border-b border-border px-3 sm:px-4 md:px-6 py-3 sm:py-4 sticky top-0 z-10 shadow-sm">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-0">
          <div className="text-center sm:text-left">
            <h1 className="text-lg sm:text-xl md:text-xl font-bold text-foreground">Google My Business Audit Report</h1>
            <p className="text-xs sm:text-sm text-muted-foreground">Generated on {reportDate}</p>
          </div>
          <div className="flex items-center gap-2 sm:gap-3">
            <img 
              src="/placeholder.svg" 
              alt="Loops Digital Logo" 
              className="h-8 w-8 sm:h-10 sm:w-10 rounded-lg"
            />
            <div className="text-center sm:text-right">
              <p className="text-xs text-muted-foreground">Report generated by</p>
              <p className="text-sm font-semibold text-foreground">Loops Digital</p>
            </div>
          </div>
        </div>
      </div>
